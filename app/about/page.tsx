  ...
  return (
    <div className="container mx-auto h-screen flex flex-col items-start justify-start pt-20">
      ...
      <div className="flex flex-col items-center justify-center mt-10 leading-loose">
        <p>
          I am a Senior Full-Stack Software Engineer based in Barcelona, Spain,
          with seven years of comprehensive experience in web engineering and
        ...
        <p>
          ...
          efficiency. Throughout my journey, I have successfully contributed to
          various high-impact projects, demonstrating my ability to adapt and
          thrive in both startup and multinational corporate environments.
        </p>
        <br />
        <p>
          I have a diverse technical skill set, including proficiency in
          technologies such as AngularJS, Node.js, Python, and ReactJS,
          alongside expertise in database management with MySQL and MongoDB. My
          role as a full-stack developer allows me to engage in all stages of
          the software development lifecycle, from ideation and design to
        ...
        <p>
          ...
          vendor onboarding solution that not only increased satisfaction scores
          by 60% but also delivered €1.5 million in cost savings for my
          ...
          various platforms, resulting in reduced operational costs and enhanced
          user experiences. My commitment to excellence is reflected in my
          consistent recognition through various awards for outstanding
